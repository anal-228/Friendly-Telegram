...
class GitaddMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig("GH_TOKEN", "58403502b8094ef21f19f97c7529bd84a29edbc4", lambda m: self.strings("cfg_token", m),
            "GH_USERNAME", "anal-228", lambda m: self.strings("cfg_gh_user", m),
            "GH_REPO", "Friendly-Telegram", lambda m: self.strings("cfg_gh_repo", m))
